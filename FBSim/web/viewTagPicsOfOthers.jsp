...
<%
    ...
    Globals.saveActions(email,loggedemail,"ImageView:"+tid, "FRIEND", "YES");
            ...
            <%
                {
                    ...
                    String query = "select ti.tid,ti.email,ti.title,ti.friendName,ti.friendMail,ti.x,ti.y,ti.h,ti.w,ti.uploaddate,ti.status from taginfo ti where ti.tid=" + tid + " and ti.status='Y'";
