    ...
    <head>
        ...
        <img src='pt_img/save.png' onclick='editTag(this);' value='Save' />");
            ...
            var addTag = function(){                
                ...
                var picId = <%=tid%>;
                makeRequest(picId,$("#title").val(),pos_x,pos_y,pos_width,pos_height,$("#sys").val(),$("#fname").val());
        ...
        <div style='margin: auto; width: 600px;'>
            <%
                String line = "";
                {
                    ...
                    String query = "select tid,filename from fileuploads where email='" + email.trim() + "' and filetype='Image' and tid=" + tid + "";
                    System.out.println(query);
            ...
            <div id='main_panel'>
                ...
                <center>
                    ...
                    <input type='hidden' readonly name='fname' id='fname' value='<%=fname%>' />
                    <div id="response">
                    </div>
                </center>
            </div>
