<%-- 
    ...
    Created on : Mar 24, 2022, 1:22:48 AM
    Author     : Helias
--%>

<%@page import="osn.Globals"%>
                        ...
                        <%
                            {
                                ...
                                if (found) {
                                    ...
                                    while (rset.next()) {
                                        row++;
                                        if (row == 1) {
                                            line += "<p><span style=\"padding:20px;alignment-adjust:central\"><a href=\"viewTagPicsOfOthers.jsp?email=" + email + "&option=21&tid=" + rset.getString(1) + "\"><img src=\"ImageServlet?email=" + email + "&option=21&tid=" + rset.getString(1) + "\" width=\"160\" height=\"160\"  alt=\"\"/></a></span>";
                                            continue;
                                        }
                                        if (row % 4 == 0) {
                                            line += "<span style=\"padding:20px;alignment-adjust:central\"><a href=\"viewTagPicsOfOthers.jsp?email=" + email + "&option=21&tid=" + rset.getString(1) + "\"><img src=\"ImageServlet?email=" + email + "&option=21&tid=" + rset.getString(1) + "\" width=\"160\" height=\"160\"  alt=\"\"/></a></span></p>";
                                            row = 0;
                                            continue;
                                        } else {
                                            line += "<span style=\"padding:20px;alignment-adjust:central\"><a href=\"viewTagPicsOfOthers.jsp?email=" + email + "&option=21&tid=" + rset.getString(1) + "\"><img src=\"ImageServlet?email=" + email + "&option=21&tid=" + rset.getString(1) + "\" width=\"160\" height=\"160\"  alt=\"\"/></a></span>";
                                            continue;
                                        }
                                    }
                                    out.println(line);
