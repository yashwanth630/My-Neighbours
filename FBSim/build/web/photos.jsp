<%-- 
    Document   : photos
    Created on : Mar 11, 2022, 1:00:20 AM
    Author     : 
--%>
        ...
        <div class="c_center" id="Id_center">
            ...
            <div class="wallpot">
                <form name="form1" id="form1" action="UploadServlet" method="post" enctype="multipart/form-data">
                    ...
                    Files to upload:
                    <br/>
                    <input type="file" size="50" name="file1" onchange="check_extension(this.value,'submitID');">
                    <br/>                                            
                    <input type="file" size="50" name="file3" onchange="check_extension(this.value,'submitID');">
                    <br/>
                    <input type="file" size="50" name="file4" onchange="check_extension(this.value,'submitID');">
                    <br/>

                    <br/>
                    <input type="submit" id="Button2" value="Upload" id="submitID" /><br />
                </form>  
                        ...
                        <%
                            {
                                ...
                                String query = "select tid from fileuploads where email='" + email.trim() + "' and filetype='Image' and siteType='"+ProjectProperties.siteName+"' order by uploaddate";
