 ...
 * @author Helias
 */
public class UploadImageFromWall extends HttpServlet {
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (fileItem.isFormField() == true) {
                    System.out.println(fileItem.getFieldName().trim()+"   ========================= "+fileItem.getString().trim());
                    if (fileItem.getFieldName().trim().equals("groupid")) {
                        groupid = fileItem.getString().trim();
                    }
